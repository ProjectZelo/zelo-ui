...
export class ZeloMockApiInterceptor implements HttpInterceptor {
    /**
     * Constructor
     */
    constructor(
        @Inject(ZELO_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        const {
            handler,
            urlParams
        } = this._zeloMockApiService.findHandler(request.method.toUpperCase(), request.url);
