...
import { ZeloMockApiReplyCallback } from '@zelo/lib/mock-api/mock-api.types';

export class ZeloMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: ZeloMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: ZeloMockApiReplyCallback): void {
        // Store the reply
