...
@Component({
    selector: 'zelo-vertical-navigation-collapsable-item',
    templateUrl: './collapsable.component.html',
    styles: [],
    animations: zeloAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ZeloVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy {
    ...
    @HostBinding('class') get classList(): any {
        return {
            'zelo-vertical-navigation-item-collapsed': this.isCollapsed,
            'zelo-vertical-navigation-item-expanded': this.isExpanded
        };
    }
    ...
    ngOnInit(): void {
        ...
        this._zeloVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._zeloVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._zeloVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._zeloVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: ZeloNavigationItem, currentUrl: string): boolean {
     ...
     * @private
     */
    private _isChildrenOf(parent: ZeloNavigationItem, item: ZeloNavigationItem): boolean {
