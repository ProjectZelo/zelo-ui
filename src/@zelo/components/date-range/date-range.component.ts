...
@Component({
    selector: 'zelo-date-range',
    templateUrl: './date-range.component.html',
    styleUrls: ['./date-range.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs: 'zeloDateRange',
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => ZeloDateRangeComponent),
            multi: true
        }
    ]
})
export class ZeloDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    @HostBinding('class.zelo-date-range') private _defaultClassNames = true;
    ...
    openPickerPanel(): void {
        ...
        const overlayRef = this._overlay.create({
            panelClass: 'zelo-date-range-panel',
            backdropClass: '',
            hasBackdrop: true,
