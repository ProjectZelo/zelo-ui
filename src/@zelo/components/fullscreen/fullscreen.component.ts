...
import { FSDocument, FSDocumentElement } from '@zelo/components/fullscreen/fullscreen.types';

@Component({
    selector: 'zelo-fullscreen',
    templateUrl: './fullscreen.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'zeloFullscreen'
})
export class ZeloFullscreenComponent implements OnInit {
