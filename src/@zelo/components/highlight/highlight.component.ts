...
import { ZeloHighlightService } from '@zelo/components/highlight/highlight.service';

@Component({
    selector: 'textarea[Zelo-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'zeloHighlight'
})
export class ZeloHighlightComponent implements OnChanges, AfterViewInit {
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _zeloHighlightService: ZeloHighlightService,
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._zeloHighlightService.highlight(this.code, this.lang));
