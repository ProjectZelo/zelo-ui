...
import { ScrollbarGeometry, ScrollbarPosition } from '@zelo/directives/scrollbar/scrollbar.types';

/**
 * Wrapper directive for the Perfect Scrollbar: https://github.com/mdbootstrap/perfect-scrollbar
 */
@Directive({
    selector: '[zeloScrollbar]',
    exportAs: 'zeloScrollbar'
})
export class ZeloScrollbarDirective implements OnChanges, OnInit, OnDestroy {
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_zeloScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() zeloScrollbar: boolean = true;
    @Input() zeloScrollbarOptions: PerfectScrollbar.Options;
    ...
    ngOnChanges(changes: SimpleChanges): void {
        // Enabled
        if ('zeloScrollbar' in changes) {
            // Interpret empty string as 'true'
            this.zeloScrollbar = coerceBooleanProperty(changes.zeloScrollbar.currentValue);

            // If enabled, init the directive
            if (this.zeloScrollbar) {
                this._init();
            }
        ...
        // Scrollbar options
        if ('zeloScrollbarOptions' in changes) {
            // Merge the options
            this._options = merge({}, this._options, changes.zeloScrollbarOptions.currentValue);
