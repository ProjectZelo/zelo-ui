...
import { ZeloAnimationCurves, ZeloAnimationDurations } from '@zelo/animations/defaults';
...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${ZeloAnimationDurations.entering} ${ZeloAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${ZeloAnimationDurations.exiting} ${ZeloAnimationCurves.acceleration}`
                }
            }
        )
    ]
